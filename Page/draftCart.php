...
<tr class="row-product">
    ...
    <td>
        ...
        <form class="edit-quantity" action="viewCart.php" method="post">
            <input class="quantity" type="number" name="new-quantity" min="1" value="<?php echo $product->Quantity ?>">
    ...
    <td>
        ...
        <button class="btn delete-btn">
            <a href="viewCart.php?product-id=<?php echo $product->ProductID ?>&cart-id=<?php echo $product->id_cart ?>">
                Remove
            </a>
        </button>
    </td>
