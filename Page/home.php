...
<header>
        ...
        <div class="container text-center">
          <div class="row">
            ...
            <div class="view">
            <button class="btn btn-light primary-btn px-5 py-2" onclick="scrollToSection1()">Explore Now</button>
            <button class="btn btn-light primary-btn px-5 py-2" onclick="scrollToSection2()">Impressive figures</button>
            </div>  
        </div>
    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-md-6 col-12">
                <div>
                    <div>
                        <img src="https://i.pinimg.com/564x/63/4e/e3/634ee34e5e9f0b27a2716e39c86a270b.jpg" width="100%" alt="Athletic Wear">
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-12">
